...
class boundary:
    ...
    def bound_calc(self,var):
            ...
            # print("Super_Final=", bound_super_final)
...
class button:
    ...
    def disp(self, operation):
        ...
        #pygame.draw.rect(win, color, [self.x + self.diff, self.y + self.diff, self.width - self.diff, self.height - self.diff])

        #print(self.mouse_click[0])
        ...
        if self.mou_pos[0] > self.x + self.diff and self.mou_pos[0] < self.x + self.width - self.diff and self.mou_pos[1] > self.y + self.diff and self.mou_pos[1] < self.y + b1.height - self.diff:
            box = pygame.draw.rect(win, self.color_2, [self.x + self.diff, self.y + self.diff, self.width - self.diff * 2,
                                                self.height - self.diff * 2])
...
while quit_game==False:
    ...
    while game_over==False:
        ...
        #pygame.draw.circle(win, midnight_blue, [current_score_x, current_score_y], current_score_radius)
        ...
        high_score_text1.disp("High-Socre", 45, orange, high_score_x - 50, high_score_y -75 )
        ...
        if snake_size>=6:
            if snake_head in snake_list[:len(snake_list)-2]:
                ...
                #save score to file here and the make it null
